...
export class ReportsController {
  ...
  @ApiResponse({
    status: 200,
    description:
      'The overall satisfaction summary report was successfully compiled.',
  ...
  @ApiOperation({
    ...
    description:
      "Generates an Excel file with a single 'Responses' sheet containing customer info and all survey question answers as columns side by side. Enforces an export limit of 10,000 records.",
  })
  @ApiResponse({
    status: 200,
